...
mapping = {
    ...
    "gill-color": {
        ...
        "gray": "g", "green": "r", "orange": "o", "pink": "p", "purple": "u",
...
st.write("Pilih deskripsi jamur menggunakan dropdown dengan nama lengkap:")

user_input = {}

for feature in features:
    options = list(mapping[feature].keys())
    selected = st.selectbox(f"{feature} :", options)
    user_input[feature] = mapping[feature][selected]  
...
if st.button("Predict"):
    ...
    if label_short == "edible":
        st.success("🌿 Hasil Prediksi: **Edible (Aman Dimakan)**")
    else:
        st.error("☠️ Hasil Prediksi: **Poisonous (Beracun)**")
